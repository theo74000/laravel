        ...
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
              ...
              <h1 class="mb-3">Voyages Destination</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-1.jpg');">
                  <div class="text">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-2.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-3.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-4.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-5.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-6.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-7.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
              ...
              <div class="col-md-6 col-lg-6 mb-4 ftco-animate">
                <a href="{route('showVoyage')}}" class="block-5" style="background-image: url('images/tour-8.jpg');">
                  <div class="text">
                    <span class="price">$399</span>
                    <h3 class="heading">Group Tour in Maldives</h3>
                    <div class="post-meta">
          ...
          <div class="col-lg-4 sidebar">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="#">Voyages <span>(12)</span></a></li>
